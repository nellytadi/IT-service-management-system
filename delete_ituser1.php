...
$sql= "DELETE FROM itstaff_login where username='$username'";
$query=mysqli_query($conn,$sql);
if(!$query){
	echo 'failed to delete user! please go back and ensure that username was entered correctly';
}
else{
	echo 'you have successfully deleted '. $username;
}


?>
<div class="text-right">
			   	 <a href=user_logout.php><button class= "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"> click here to log out</button></a>
			    	</div>
</head>
</html>