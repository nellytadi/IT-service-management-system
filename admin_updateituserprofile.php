...
$result= "SELECT * FROM itstaff_login WHERE username='$username'";
$query = mysqli_query($conn,$result) or die ('error querying the database'. mysqli_error());
	...
	echo '
	<form action="admin_updateituserprofile_db.php" method="POST">
...
<div class="col-md-6">
<input type="text" name="fullname"  class="form-control" value="'.$row['staffname'].'">
</div>
</div>
<div class= "form-group col-md-8">
        <div class="col-md-3">
...
<div class="col-md-6">
<input type="text" name="department"  class="form-control" value="'.$row['email'].'">
</div>
</div>
