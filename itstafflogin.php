				...
				<!-- Wrapper -->
					<section id="wrapper">
						...
						<!-- Content -->
							...
							<div class="wrapper">
								<div class="inner">
									<form method="POST" action="itstaff_db.php">
								<div class="field">
									<label for="name">User Name:</label>
									<input type="text" name="itname" id="name" />
								</div>
								<div class="field">
									<label for="password">Password:</label>
									<input type="password" name="itpass" id="password" />
								</div>
