...
$id=stripslashes($id);
    ...
    $phonenumber=stripslashes($phonenumber);
        ...
        $result ="UPDATE itstaff_login SET username='$username' WHERE itstaff_login . id='$id';";
        $result.="UPDATE itstaff_login SET  password='$password' WHERE itstaff_login . id='$id';";
          $result.="UPDATE itstaff_login SET  staffname='$fullname'WHERE  itstaff_login . id='$id';";
           $result.="UPDATE itstaff_login SET  email='$department' WHERE itstaff_login . id='$id';";
              $result.="UPDATE itstaff_login SET  phonenumber='$phonenumber' WHERE  itstaff_login . id='$id';";
