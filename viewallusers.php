...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <link rel="stylesheet" href="material design lite/material.min.css">
      ...
      <script defer src="material design lite/material.min.js"></script>      <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script><style type="text/css">
      	    #image{
        height:150px;
        width: 150px;
    }
...
while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
	...
	<tbody>
		<tr>
			...
			<td>'.$row['email'].'</td>
			<td><a href="admin_updateuserprofile.php?username='.$row['username'].'"><button>update</button></a><a href="delete_user1.php?id='.$row['id'].'"><button>delete</button></a></td>
		</tr>
		</tbody>
	';
}
